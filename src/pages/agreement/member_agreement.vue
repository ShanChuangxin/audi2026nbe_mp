...
//   if (query.type) {
//     const res = await getAgreementAPI(query.type)
//     agreementInfo.value = res.data.agreementInfo
//   }
// }
...
<template>
  <image
    src="https://www.mbcstyle.cn/projects/mbc-static/wmp/static/images/agreement/member_agreement.jpg"
    mode="widthFix"
    style="width: 100%;"
  />
</template>
